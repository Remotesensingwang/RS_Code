...
pro fy3d_cloud_test,FY3DFile,TOAdata,landcover,CloudData
  compile_opt idl2
  ...
  print,min(Data0047)
  print,mean(Data0047)
  ;write_tiff,'H:\dtcloud\02cloudmaster\2\pro\std055.tif',Data0055_result.std,planarconfig=2,compression=1,/float
  ;write_tiff,'H:\dtcloud\02cloudmaster\2\pro\std138.tif',Data0138_result.std,planarconfig=2,compression=1,/float    
  ;*****************************************************去水体处理*****************************************************

  ;;水体
  NDWIData = (Data0055-Data0087) / (Data0055+Data0087)
  result_tiff_name_cloud='H:\dtcloud\02cloudmaster\1\'+'NDWI0101.tif'
  ;write_tiff,result_tiff_name_cloud,NDWIData,planarconfig=2,compression=1,/float
;  CloudData[WHERE((NDWIData GT 0.0) and (Data0213 lt 0.16) and (CloudData eq 0))] = 60B
  CloudData[WHERE((NDWIData ge 0.0)  and (CloudData eq 0))] = 60B
  ;CloudData[WHERE((NDWIData ge -0.2) and (Data0213 lt 0.16) and (CloudData eq 0))] = 60B
  ...
  result_tiff_name_cloud='H:\dtcloud\02cloudmaster\1\'+'nvsi.tif'
  ;write_tiff,result_tiff_name_cloud,ndsi,planarconfig=2,compression=1,/float
end