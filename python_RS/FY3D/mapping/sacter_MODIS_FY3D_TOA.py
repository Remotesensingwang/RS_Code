...
input_file_fy3d=r'C:\Users\lenovo\Desktop\toa\FY3D\snowwatercloud\Yang(tbb)\2019\dh_toa2019_fy3d_dropna.xlsx'
input_file_modis=r'C:\Users\lenovo\Desktop\toa\MODIS\snowwatercloud\2019\dh_dingbiao2019_modis_dropna.xlsx'

output_fig=r'C:\Users\lenovo\Desktop\toa\com\2019'+'\\'
# *****************************Excel文件数据处理（去除NAN）*****************************
df_fy3d = pd.read_excel(input_file_fy3d,header=None)  # From an Excel file
df_modis = pd.read_excel(input_file_modis,header=None)  # From an Excel file

modis_band=[9,10,7,8,28,12,13]
# 以一年的日期为横坐标散点图制作（横坐标以月份为单位显示）B1-B19
for band in range(7,14):
    figname = output_fig + 'toa2019_fy3d_modis_B{index}.png'.format(index=band - 6)
